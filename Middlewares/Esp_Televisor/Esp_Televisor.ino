...
bool relayOn = true;           // Estado del relé: true = encendido, false = apagado
float acumulado = 0.0;         // Energía acumulada en Wh
const unsigned long intervaloMs = 2000;  // Intervalo de 2 segundos

// Callback para recibir órdenes de encendido/apagado del relé
...
void reconnect() {
  while (!client.connected()) {
    ...
    if (client.connect(clientId.c_str(), mqtt_username, mqtt_password)) {
      ...
      // Suscribirse para recibir órdenes del relé
